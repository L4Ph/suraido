...
Creates a slide project built on [suraido.js](../suraido.js). Pass what you have already decided; you
...
passed to `deck()`, how a slide redraws, styles are overridden from outside the
`@layer`, and so on.
