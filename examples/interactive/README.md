...
with no code here looking after either. The tally shows what an `atom` is for: the votes are
cast on the first slide, which unmounts as soon as you leave it, and they are still there at
the end.
